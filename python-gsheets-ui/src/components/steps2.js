            ...
            <div className="steps2-container3">
              <div className="steps2-container4 thq-card">
                <h2 className="thq-heading-2">
                  {props.step1Title ?? (
                    <Fragment>
                      <span className="steps2-text29">Select a Book Cover</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text25">
                        Choose from the 6 different book covers displayed on the
                        screen.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        Once you select a book cover, the story will open on the
                        screen. You can choose to read it yourself or have it
                        dictated aloud.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text26">
                        After reading the story, you will be presented with
                        several prompts to select which adventure path to take
                        next.
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="steps2-container7 thq-card">
                <h2 className="thq-heading-2">
                  {props.step4Title ?? (
                    <Fragment>
                      <span className="steps2-text32">Continue Exploring</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        The story does not end! Keep selecting different paths
